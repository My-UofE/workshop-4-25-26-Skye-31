...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("\nR1: Width: "+myRect1.getWidth()+", Height: "+myRect1.getHeight());
		System.out.println("R2: Width: "+myRect2.getWidth()+", Height: "+myRect2.getHeight());
		System.out.println("R3: Width: "+myRect3.getWidth()+", Height: "+myRect3.getHeight());
